{if isset(Session::get('autenticate'))} 
 <!-- Sidebar menu-->
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{$_layoutParams.route_img}icon.jpg" width="40px" alt="User Image">
        <div>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Usuarios</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="{$_layoutParams.root}users"  rel="noopener"><i class="icon fa fa-circle-o"></i> Usarios</a></li>
